...
def main(modes: List[str]):
    ...
    result_dirpath = Path(__file__).parent / "results/Imagenet40BlackR18"
    ...
    dataset = ImagenetDataset(cls_to_use=pipeline_params['cls_to_use'],
...
if __name__ == '__main__':
    modes = ['bts_startsame']
    modes4 = ['stb_endsame', 'llo', 'single', 'random_oneseq', 'random1', 'llo']
    modes2 = ['as_is']
