...
class VOCSingleTest:
    ...
    def run_test(self,
        ...
        test_loader = VOCDistancingImageLoader(self.size, p=self.target_size,
        ...
        for fold in range(self.n_folds):
            ...
            train_loader = VOCDistancingImageLoader(self.size, p=self.target_size,
                                                    background_generator=self.background,
            ...
            val_loader = VOCDistancingImageLoader(self.size, p=self.target_size,
                                                  background_generator=self.background,
