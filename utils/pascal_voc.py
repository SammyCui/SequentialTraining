...
def parse_args():
    ...
    parser.add_argument('--download-dir', type=str, default='/Users/xuanmingcui/Documents/projects/cnslab/cnslab/SequentialTraining/datasets', help='dataset directory on disk')
