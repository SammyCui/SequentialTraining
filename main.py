...
def main(mode, bg, suffix):
    ...
    result_dirpath = Path(__file__).parent / "results/VOC8Alex_5runs"
    ...
    print(' ---  Running  ---')
    VOCpipeline.run(criterion_object=criterion_object, optimizer_object=optimizer_object, patience=20,
